...
public class Account {
    ...
    // final method locked against overriding[cite: 3]
    public final double calculateLateFee(int daysLate) {
        // Based on sample output, fee is 1% of total fee per day late
        return (totalFee * 0.01) * daysLate; 
    }

    // final method to print summary or skip[cite: 3]
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < regNos.length; i++) {
            ...
            acc.printSummary(daysLate[i]); // Process in single pass[cite: 3]
        }
    }
}